...
public class U2_L02_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    [SerializeField] bool _isViewed = false;
    [SerializeField] AudioSource _audioSource;
    [SerializeField] AudioClip _introClip;
    [SerializeField] AudioClip[] _char_1, _char_2;
    [SerializeField] Sprite[] _charS_1, _charS_2;
    ...
    {
        transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "Greetings in Action\r\n\r\n\r\n<size=75> Listen to the five dialogues as they appear </size>";
        ...
        foreach (Transform button in _buttonParent)
        {
            ...
            _char1TextObj.GetComponent<Image>().sprite = _charS_1[_currentAudioIndex];
            ...
            _char2TextObj.GetComponent<Image>().sprite = _charS_2[_currentAudioIndex];
