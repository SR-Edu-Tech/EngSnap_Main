...
[Serializable]
public class U8_G01_Junior1A_QuestionData
{
...
public class U8_G01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    [SerializeField] U8_G01_Junior1A_QuestionData[] _questionData;
    ...
    {
        foreach (U8_G01_Junior1A_QuestionData item in _questionData)
        {
            int _optionIndex = 0;
