...
public class U8_RWD_Junior1A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "CONVERSATIONS OCEAN CHAMPION UNIT 8 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
