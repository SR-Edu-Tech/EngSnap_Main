...
public class U9_RWD_Junior1A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "IN OUR CLASS OCEAN CHAMPION UNIT 9 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
