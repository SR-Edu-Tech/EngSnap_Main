...
public class U7_RWD_Junior1A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "THE CLASSROOM OCEAN CHAMPION UNIT 7 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
