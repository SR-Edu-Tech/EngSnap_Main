...
public class U14_RWD_01_Junior1A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "MY REQUEST MAKER CHAMPION UNIT 14 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
