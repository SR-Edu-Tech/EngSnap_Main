...
[Serializable]
public class U13_G01_Junior1A_QuestionData
{
...
public class U13_G01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    [SerializeField] U13_G01_Junior1A_QuestionData[] _questionData;
    ...
    {
        foreach (U13_G01_Junior1A_QuestionData item in _questionData)
        {
