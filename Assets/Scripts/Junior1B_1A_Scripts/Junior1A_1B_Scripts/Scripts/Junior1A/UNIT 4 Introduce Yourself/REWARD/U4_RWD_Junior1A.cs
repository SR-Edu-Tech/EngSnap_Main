...
public class U4_RWD_Junior1A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "INTRODUCE YOURSELF OCEAN CHAMPION UNIT 4 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
