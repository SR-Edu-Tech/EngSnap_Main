...
public class U11_RWD_01_Junior1A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "MY FAMILY OCEAN CHAMPION UNIT 11 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
