...
[Serializable]
public class U9_G01_Junior1B_QuestionData
{
...
public class U9_G01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    [SerializeField] U9_G01_Junior1B_QuestionData[] _questionData;
    ...
    {
        foreach (U9_G01_Junior1B_QuestionData item in _questionData)
        {
