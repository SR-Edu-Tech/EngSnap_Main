...
{
    [Serializable]
    public class U9_Q01_Junior1B_QuestionData
    {
    ...
    public class U9_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
    {
        ...
        [SerializeField] U9_Q01_Junior1B_QuestionData[] _questions;
