...
[Serializable]
public class U10_G01_Junior1B_QuestionData
{
...
public class U10_G01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    [SerializeField] U10_G01_Junior1B_QuestionData[] _questionData;
    ...
    {
        foreach (U10_G01_Junior1B_QuestionData item in _questionData)
        {
