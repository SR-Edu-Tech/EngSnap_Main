...
[Serializable]
public class U10_RP01_Junior1B_QuestionData
{
...
public class U10_RP01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    [Header("=== Quiz Configuration ===")]
    [SerializeField] U10_RP01_Junior1B_QuestionData[] _questionData;
