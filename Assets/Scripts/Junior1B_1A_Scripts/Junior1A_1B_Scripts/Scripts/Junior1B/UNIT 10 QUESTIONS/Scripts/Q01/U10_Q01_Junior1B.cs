...
{
    [Serializable]
    public class U10_Q01_Junior1B_QuestionData
    {
    ...
    public class U10_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
    {
        ...
        [SerializeField] U10_Q01_Junior1B_QuestionData[] _questions;
