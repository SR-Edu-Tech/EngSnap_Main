...
[Serializable]
public class U8_G01_QuestionData
{
...
public class U8_G01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    [Header("=== Game Data ===")]
    [SerializeField] U8_G01_QuestionData[] _questions;
    ...
    private void LoadQuestion(int questionIndex)
    {
        ...
        UpdateProgressUI();
        U8_G01_QuestionData currentData = _questions[questionIndex];
    ...
    {
        U8_G01_QuestionData currentQuestion = _questions[_currentQuestionIndex];
