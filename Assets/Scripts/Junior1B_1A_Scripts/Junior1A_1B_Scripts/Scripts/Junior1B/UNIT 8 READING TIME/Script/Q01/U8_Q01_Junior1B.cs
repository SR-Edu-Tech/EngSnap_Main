...
{
    [Serializable]
    public class U8_Q01_Junior1B_QuestionData
    {
    ...
    public class U8_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
    {
        ...
        [SerializeField] U8_Q01_Junior1B_QuestionData[] _questions;
