...
[Serializable]
public class U14_RP01_Junior1B_QuestionData
{
...
public class U14_RP01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    [Header("=== Quiz Configuration ===")]
    [SerializeField] U14_RP01_Junior1B_QuestionData[] _questionData;
