...
public class U14_R02_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    IEnumerator OnTab()
    {
        ...
        // Cascade the content buttons into active view
    ...
    IEnumerator AutoRunAudios()
    {
        ...
        // FIX: Unlock all buttons immediately so the player can click them manually!
        foreach (Transform child in content)
        {
            child.GetComponent<Button>().interactable = true;
        }

        // Instantly mark the current tab as opened/completed since it is ready for player interaction
