...
[Serializable]
public class U14_G01_Junior1B_QuestionData
{
...
public class U14_G01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    [SerializeField] U14_G01_Junior1B_QuestionData[] _questionData;
    ...
    {
        foreach (U14_G01_Junior1B_QuestionData item in _questionData)
        {
