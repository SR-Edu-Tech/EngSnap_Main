...
{
    [Serializable]
    public class U14_Q01_Junior1B_QuestionData
    {
    ...
    public class U14_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
    {
        ...
        [SerializeField] U14_Q01_Junior1B_QuestionData[] _questions;
