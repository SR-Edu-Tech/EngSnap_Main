...
public class U14_RWD_Junior1B : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "YOU COMPLETED UNIT 14 AND NOW ARE A SONG MASTER!";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
