...
[Serializable]
public class U12_G01_Junior1B_QuestionData
{
...
public class U12_G01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    [SerializeField] U12_G01_Junior1B_QuestionData[] _questionData;
    ...
    {
        foreach (U12_G01_Junior1B_QuestionData item in _questionData)
        {
