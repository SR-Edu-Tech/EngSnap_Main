...
{
    [Serializable]
    public class U11_Q01_Junior1B_QuestionData
    {
    ...
    public class U11_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
    {
        ...
        [SerializeField] U11_Q01_Junior1B_QuestionData[] _questions;
