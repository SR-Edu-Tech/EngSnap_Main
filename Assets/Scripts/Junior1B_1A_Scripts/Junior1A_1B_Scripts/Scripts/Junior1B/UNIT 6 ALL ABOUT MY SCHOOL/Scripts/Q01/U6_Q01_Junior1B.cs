...
{
    [Serializable]
    public class U6_Q01_Junior1B_QuestionData
    {
    ...
    public class U6_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
    {
        ...
        [SerializeField] U6_Q01_Junior1B_QuestionData[] _questions;
