...
[Serializable]
public class U6_W01_Junior1B_QuestionData
{
    public string[] OptionTexts;
    public int CorrectOptionIndex;
}

public class U6_W01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    [SerializeField] U6_W01_Junior1B_QuestionData[] _questionData;
        ...
        foreach (Transform button in _questionParent.transform)
        {
            if (_currentDefaultOptionIndex < _questionData.Length)
            {
                ...
                if (textMesh != null)
                {
                    ...
                    if (textMesh.TryGetComponent(out TextPopEffect_Junior1B textPop)) 
    ...
    IEnumerator CheckOption()
    {
        ...
        if (isCorrect)
        {
            ...
            if (_clickedOptionText != null)
            {
                ...
                if (_clickedOptionText.TryGetComponent(out TextPopEffect_Junior1B textPop)) 
        ...
        else
        {
            ...
            if (_audioSource != null && _incorrectClip != null)
            {
                ...
                if (targetButton.TryGetComponent(out WiggleEffect_Junior1B wiggle)) 
                    wiggle.enabled = true;
