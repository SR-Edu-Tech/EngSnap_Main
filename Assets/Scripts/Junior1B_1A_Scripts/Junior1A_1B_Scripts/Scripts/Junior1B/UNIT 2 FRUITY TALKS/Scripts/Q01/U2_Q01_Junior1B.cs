...
[Serializable]
public class U2_Q01_Junior1B_QuestionData
{
...
public class U2_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    [SerializeField] AudioSource _audioSource;
    [SerializeField] AudioClip _introClip, _wrongClip, _correctClip;
    [SerializeField] U2_Q01_Junior1B_QuestionData[] _questions;
    ...
    private void SetupQuestionView()
    {
        ...
        // 3. Handle Question 4 image system dynamically
        if (_imageObj != null)
        {
