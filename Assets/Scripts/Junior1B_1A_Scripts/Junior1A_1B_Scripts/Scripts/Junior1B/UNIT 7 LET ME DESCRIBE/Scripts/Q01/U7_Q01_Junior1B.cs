...
{
    [Serializable]
    public class U7_Q01_Junior1B_QuestionData
    {
    ...
    public class U7_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
    {
        ...
        [SerializeField] U7_Q01_Junior1B_QuestionData[] _questions;
