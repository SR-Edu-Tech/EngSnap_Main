...
{
    [Serializable]
    public class U13_Q01_Junior1B_QuestionData
    {
    ...
    public class U13_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
    {
        ...
        [SerializeField] U13_Q01_Junior1B_QuestionData[] _questions;
