...
[Serializable]
public class U11_Q01_Junior1A_QuestionData
{
...
public class U11_Q01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    [SerializeField] private U11_Q01_Junior1A_QuestionData[] _questions;
    ...
    private IEnumerator CheckAnswer(int index)
    {
        ...
        if (index == _questions[_currentQuestionIndex].CorrectAnsIndex)
        {
            ...
            if (correctBtn.TryGetComponent(out PopEffect_Junior1A pop))
            {
                pop.enabled = false;
                pop.enabled = true;
            }
        ...
        else
        {
            ...
            if (wrongBtn.TryGetComponent(out WiggleEffect_Junior1A1 wiggle)) wiggle.enabled = true;
