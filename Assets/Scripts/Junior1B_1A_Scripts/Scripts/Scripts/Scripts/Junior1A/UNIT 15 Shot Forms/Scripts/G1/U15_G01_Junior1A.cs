...
[Serializable]
public class U15_G01_Junior1A_QuestionData
{
...
public class U15_G01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    [SerializeField] U15_G01_Junior1A_QuestionData[] _questionData;
    ...
    {
        foreach (U15_G01_Junior1A_QuestionData item in _questionData)
        {
