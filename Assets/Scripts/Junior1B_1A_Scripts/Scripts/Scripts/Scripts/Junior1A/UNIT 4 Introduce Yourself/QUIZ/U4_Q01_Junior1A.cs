...
[Serializable]
public class U4_Q01_Junior1A_QuestionData
{
...
public class U4_Q01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    [SerializeField] AudioSource _audioSource;
    [SerializeField] AudioClip _introClip, _wrongClip, _correctClip;
    [SerializeField] U4_Q01_Junior1A_QuestionData[] _questions;
    ...
    IEnumerator CheckAnswer(int index)
    {
        ...
        if (_currentQuestionIndex < _questions.Length - 1)
        {
            ...
            _headingObj.SetActive(true);
            _object.SetActive(true);
            if (_currentQuestionIndex == 4) _imageObj.SetActive(true);
