...
[Serializable]
public class U12_G01_Junior1A_QuestionData
{
...
public class U12_G01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    [SerializeField] U12_G01_Junior1A_QuestionData[] _questionData;
    ...
    {
        foreach (U12_G01_Junior1A_QuestionData item in _questionData)
        {
