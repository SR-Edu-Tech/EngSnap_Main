...
public class U12_RWD_01_Junior1A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "MY WELL MANNERED CHAMPION UNIT 12 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
