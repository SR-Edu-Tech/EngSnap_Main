...
[Serializable]
public class U3_G01_Junior1B_QuestionData
{
...
public class U3_G01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    [SerializeField] U3_G01_Junior1B_QuestionData[] _questionData;
    ...
    IEnumerator MoveFish()
    {
        ...
        foreach (U3_G01_Junior1B_QuestionData item in _questionData)
        {
