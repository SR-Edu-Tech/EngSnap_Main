...
[Serializable]
public class U2_G01_Junior1B_QuestionData
{
...
public class U2_G01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    [SerializeField] U2_G01_Junior1B_QuestionData[] _questionData;
    ...
    IEnumerator MoveFish()
    {
        ...
        foreach (U2_G01_Junior1B_QuestionData item in _questionData)
        {
