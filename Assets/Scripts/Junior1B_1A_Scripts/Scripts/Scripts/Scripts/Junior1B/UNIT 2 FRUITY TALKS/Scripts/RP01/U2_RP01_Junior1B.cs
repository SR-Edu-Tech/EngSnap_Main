...
[Serializable]
public class U2_RP01_Junior1B_QuestionData
{
...
public class U2_RP01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    [SerializeField] U2_RP01_Junior1B_QuestionData[] _questionData;
    ...
    IEnumerator Checker()
    {
        if (_questionData[_currentQuestionIndex].CorrectAnsIndex == _currentOptionIndex)
        {
            ...
            if (_optionObjs[_currentOptionIndex].TryGetComponent(out Popeffect_Junior1B pop))
            {
                pop.enabled = false;
                pop.enabled = true;
            }
        ...
        else
        {
            ...
            if (_optionObjs[_currentOptionIndex].TryGetComponent(out WiggleEffect_Junior1B wiggle))
            {
