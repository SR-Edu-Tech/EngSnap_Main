...
public class U6_W01_Junior1B : MonoBehaviour, Interfaces_Junior1B
{
    ...
    IEnumerator Starter()
    {
        ...
        foreach (Transform button in _questionParent.transform)
        {
            if (_currentDefaultOptionIndex < _questionData.Length)
            {
                ...
                button.GetChild(0).GetChild(0).GetChild(0).GetComponent<TextPopEffect_Junior1B>().enabled = false;
    ...
    IEnumerator CheckOption()
    {
        ...
        if (isCorrect)
        {
            ...
            _clickedOptionText.GetComponent<TextPopEffect_Junior1B>().enabled = true;
        ...
        else
        {
            ...
            _audioSource.Play();
            _spawnBox.GetChild(_currentAnswerIndex).GetComponent<WiggleEffect_Junior1B>().enabled = true;
