...
{
    [Serializable]
    public class U5_Q01_Junior1B_QuestionData
    {
    ...
    public class U5_Q01_Junior1B : MonoBehaviour, Interfaces_Junior1B
    {
        ...
        [SerializeField] U5_Q01_Junior1B_QuestionData[] _questions;
