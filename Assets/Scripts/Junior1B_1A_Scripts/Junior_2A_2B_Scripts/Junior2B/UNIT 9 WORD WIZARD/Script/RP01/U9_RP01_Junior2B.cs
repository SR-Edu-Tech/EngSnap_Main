...
[Serializable]
public class U9_RP01_Junior2B_QuestionData
{
...
public class U9_RP01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    [Header("=== Quiz Configuration ===")]
    [SerializeField] U9_RP01_Junior2B_QuestionData[] _questionData;
