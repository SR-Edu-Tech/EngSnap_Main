...
{
    [Serializable]
    public class U9_Q01_Junior2B_QuestionData
    {
    ...
    public class U9_Q01_Junior2B : MonoBehaviour, Interfaces_Junior2B
    {
        ...
        [SerializeField] U9_Q01_Junior2B_QuestionData[] _questions;
