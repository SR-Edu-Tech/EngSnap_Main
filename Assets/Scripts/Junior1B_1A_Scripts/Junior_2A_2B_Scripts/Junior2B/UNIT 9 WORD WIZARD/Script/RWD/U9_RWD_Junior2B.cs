...
public class U9_RWD_Junior2B : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "CONGRATS ON FINISHING UNIT 9!! YOU ARE NOW A STAR";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
