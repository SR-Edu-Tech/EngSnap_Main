...
[Serializable]
public class U5_G01_Junior2B_QuestionData
{
...
public class U5_G01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    ...
    [SerializeField] U5_G01_Junior2B_QuestionData[] _questionData;
    ...
    IEnumerator MoveFish()
    {
        ...
        foreach (U5_G01_Junior2B_QuestionData item in _questionData)
        {
