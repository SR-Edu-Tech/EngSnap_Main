...
{
    [Serializable]
    public class U10_Q01_Junior2B_QuestionData
    {
    ...
    public class U10_Q01_Junior2B : MonoBehaviour, Interfaces_Junior2B
    {
        ...
        [SerializeField] U10_Q01_Junior2B_QuestionData[] _questions;
