...
[Serializable]
public class U10_RP01_Junior2B_QuestionData
{
...
public class U10_RP01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    [Header("=== Quiz Configuration ===")]
    [SerializeField] U10_RP01_Junior2B_QuestionData[] _questionData;
