...
public class U10_RWD_Junior2B : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "YOU HAVE NOW FINISHED UNIT 10, SINGING CHAMPION";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
