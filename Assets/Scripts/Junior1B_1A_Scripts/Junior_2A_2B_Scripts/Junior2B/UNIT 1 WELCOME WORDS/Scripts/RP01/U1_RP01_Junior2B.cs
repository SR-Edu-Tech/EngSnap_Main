...
[Serializable]
public class U1_RP01_Junior2B_QuestionData
{
...
public class U1_RP01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    [SerializeField] U1_RP01_Junior2B_QuestionData[] _questionData;
    ...
    IEnumerator Checker()
    {
        if (_questionData[_currentQuestionIndex].CorrectAnsIndex == _currentOptionIndex)
        {
            ...
            _optionObjs[_currentOptionIndex].GetComponent<Popeffect_Junior2B>().enabled = false;
            _optionObjs[_currentOptionIndex].GetComponent<Popeffect_Junior2B>().enabled = true;
        ...
        else
        {
            ...
            _optionObjs[_currentOptionIndex].GetComponent<WiggleEffect_Junior2B>().enabled = true;
            yield return new WaitForSeconds(_audioSource.clip.length);
            _optionObjs[_currentOptionIndex].GetComponent<Image>().color = Color.white;
        }
    }
