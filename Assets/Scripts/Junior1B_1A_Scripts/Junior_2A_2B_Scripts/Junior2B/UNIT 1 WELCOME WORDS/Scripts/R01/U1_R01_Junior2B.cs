...
public class U1_R01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    ...
    IEnumerator Starter()
    {
        // Reset score containers whenever the scene re-initializes
        ...
        if (_buttonParent != null)
        {
            ...
            {
                var pop = button.GetComponent<Popeffect_Junior2B>();
        ...
        {
            var optionPop = _optionParent.GetChild(0).GetComponent<Popeffect_Junior2B>();
    ...
    public void Repeat()
    {
        ...
        // Reset runtime scoring trackers for another playthrough block
        _clickedButtons.Clear();
        _currentScore = 0;
        UpdateScoreUI();
    ...
    /// <summary>
    /// Helper method to safely format and change the on-screen text.
    /// </summary>
