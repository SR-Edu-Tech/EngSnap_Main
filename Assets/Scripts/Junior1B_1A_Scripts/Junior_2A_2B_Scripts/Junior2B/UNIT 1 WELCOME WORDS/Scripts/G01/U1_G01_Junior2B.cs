...
[Serializable]
public class U1_G01_Junior2B_QuestionData
{
...
public class U1_G01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    ...
    [SerializeField] U1_G01_Junior2B_QuestionData[] _questionData;
    ...
    {
        foreach (U1_G01_Junior2B_QuestionData item in _questionData)
        {
            if (_fish.TryGetComponent(out SlideEffect_Junior2B baseSlide))
            {
                ...
                _selectedButton == _buttonParent.transform.GetChild(item.CorrectAnsIndex))
            {
                ...
                if (_selectedButton.TryGetComponent(out Popeffect_Junior2B clickPop))
                {
            ...
            if (_fish.TryGetComponent(out SlideEffect_Junior2B exitSlide))
            {
