...
[Serializable]
public class U6_G01_Junior2B_QuestionData
{
...
public class U6_G01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    ...
    [SerializeField] U6_G01_Junior2B_QuestionData[] _questionData;
    ...
    IEnumerator MoveFish()
    {
        ...
        foreach (U6_G01_Junior2B_QuestionData item in _questionData)
        {
