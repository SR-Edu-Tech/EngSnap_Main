...
{
    [Serializable]
    public class U6_Q01_Junior2B_QuestionData
    {
    ...
    public class U6_Q01_Junior2B : MonoBehaviour, Interfaces_Junior2B
    {
        ...
        [SerializeField] U6_Q01_Junior2B_QuestionData[] _questions;
