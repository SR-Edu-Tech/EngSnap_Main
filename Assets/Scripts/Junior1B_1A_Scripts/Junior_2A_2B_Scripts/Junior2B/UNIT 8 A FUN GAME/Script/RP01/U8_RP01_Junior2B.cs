...
[Serializable]
public class U8_RP01_Junior2B_QuestionData
{
...
public class U8_RP01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    [Header("=== Quiz Configuration ===")]
    [SerializeField] U8_RP01_Junior2B_QuestionData[] _questionData;
