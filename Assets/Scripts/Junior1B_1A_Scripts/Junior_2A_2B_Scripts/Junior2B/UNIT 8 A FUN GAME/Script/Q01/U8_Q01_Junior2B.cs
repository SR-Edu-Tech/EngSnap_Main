...
{
    [Serializable]
    public class U8_Q01_Junior2B_QuestionData
    {
    ...
    public class U8_Q01_Junior2B : MonoBehaviour, Interfaces_Junior2B
    {
        ...
        [SerializeField] U8_Q01_Junior2B_QuestionData[] _questions;
