...
public class U8_RWD_Junior2B : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "YOU HAVE FINISHED UNIT 8, YOU ARE NOW A WHISPER KING";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
