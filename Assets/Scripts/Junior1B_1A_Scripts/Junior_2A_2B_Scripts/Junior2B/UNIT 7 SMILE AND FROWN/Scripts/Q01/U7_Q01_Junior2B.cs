...
{
    [Serializable]
    public class U7_Q01_Junior2B_QuestionData
    {
        ...
        public bool UseCustomButtonColors; // Check this for custom colors on options
        public Color[] CustomButtonColors; // Element 0 = Green, Element 1 = Red, Element 2 = Blue
    }

    public class U7_Q01_Junior2B : MonoBehaviour, Interfaces_Junior2B
    {
        ...
        [SerializeField] U7_Q01_Junior2B_QuestionData[] _questions;
        ...
        private void ResetButtonsToDefaultState()
        {
            ...
            foreach (Transform obj in _buttonParent.transform)
            {
                ...
                if (obj.TryGetComponent(out Popeffect_Junior2B pop)) pop.enabled = false;
            }
        }
