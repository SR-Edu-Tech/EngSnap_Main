...
[Serializable]
public class U7_G01_Junior2B_QuestionData
{
...
public class U7_G01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    ...
    [SerializeField] U7_G01_Junior2B_QuestionData[] _questionData;
    ...
    IEnumerator MoveFish()
    {
        ...
        foreach (U7_G01_Junior2B_QuestionData item in _questionData)
        {
