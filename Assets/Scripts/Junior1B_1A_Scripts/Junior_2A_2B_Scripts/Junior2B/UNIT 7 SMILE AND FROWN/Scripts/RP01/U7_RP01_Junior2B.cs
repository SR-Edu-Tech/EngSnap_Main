...
[Serializable]
public class U7_RP01_Junior2B_QuestionData
{
...
public class U7_RP01_Junior2B : MonoBehaviour, Interfaces_Junior2B
{
    [Header("=== Quiz Configuration ===")]
    [SerializeField] U7_RP01_Junior2B_QuestionData[] _questionData;
