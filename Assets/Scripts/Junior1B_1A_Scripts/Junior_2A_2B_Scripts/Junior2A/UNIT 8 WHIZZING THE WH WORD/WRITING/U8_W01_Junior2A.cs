...
[Serializable]
public class U8_W01_Junior2A_QuestionData
{
...
public class U8_W01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    ...
    [SerializeField] U8_W01_Junior2A_QuestionData[] _questionData;
    ...
    IEnumerator MoveFish()
    {
        ...
        foreach (U8_W01_Junior2A_QuestionData item in _questionData)
        {
