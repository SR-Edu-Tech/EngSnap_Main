...
[Serializable]
public class U8_Q01_Junior2A_QuestionData
{
...
public class U8_Q01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    [SerializeField] AudioSource _audioSource;
    [SerializeField] AudioClip _introClip, _wrongClip, _correctClip;
    [SerializeField] U8_Q01_Junior2A_QuestionData[] _questions;
    ...
    IEnumerator StartQuiz()
    {
        ...
        {
            obj.GetComponent<PopEffect_Junior2A>().enabled = obj.GetComponent<Button>().enabled = true;
        }
