...
public class U2_RWD_Junior2A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "YOU ARE NOW CHAMPION OF NOW, YESTERDAY AND TOMORROW";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
