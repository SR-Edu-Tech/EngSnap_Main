...
[Serializable]
public class U2_G01_Junior2A_QuestionData
{
...
public class U2_G01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    ...
    [SerializeField] U2_G01_Junior2A_QuestionData[] _questionData;
    ...
    {
        foreach (U2_G01_Junior2A_QuestionData item in _questionData)
        {
        ...
        // --- UPDATED END SEQUENCING ---
        // 1. Activate the stars panel canvas container
        _starsPanel.SetActive(true);

        // 2. Animate and pop up the stars first
        ...
        // 3. Turn off the main game HUD layout and trigger the final view setup
