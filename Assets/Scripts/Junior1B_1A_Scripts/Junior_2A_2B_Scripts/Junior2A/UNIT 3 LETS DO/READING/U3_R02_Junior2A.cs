...
public class U3_R02_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    ...
    IEnumerator OnTab()
    {
        ...
        if (_currentTabIndex >= 0 && _currentTabIndex < TabPs.Length && TabPs[_currentTabIndex] != null)
        {
            ...
            // Sequentially introduce buttons on user view layers
            ...
            // --- AUTOPLAY REMOVED ---
            // Execution pauses here naturally to let the player manually click buttons.
        }
    }
