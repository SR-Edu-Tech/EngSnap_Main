...
[Serializable]
public class U5_G01_Junior2A_QuestionData
{
...
public class U5_G01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    ...
    [SerializeField] U5_G01_Junior2A_QuestionData[] _questionData;
    ...
    IEnumerator MoveFish()
    {
        ...
        foreach (U5_G01_Junior2A_QuestionData item in _questionData)
        {
            ...
            else
            {
                ...
                if (_selectedButton.TryGetComponent(out WiggleEffect_Junior2A wiggle)) wiggle.enabled = true;
            }
