...
[Serializable]
public class U11_Q01_Junior2A_QuestionData
{
...
public class U11_Q01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    ...
    [SerializeField] private U11_Q01_Junior2A_QuestionData[] _questions;
    ...
    private IEnumerator CheckAnswer(int index)
    {
        ...
        else
        {
            ...
            if (wrongBtn.TryGetComponent(out WiggleEffect_Junior2A wiggle)) wiggle.enabled = true;
