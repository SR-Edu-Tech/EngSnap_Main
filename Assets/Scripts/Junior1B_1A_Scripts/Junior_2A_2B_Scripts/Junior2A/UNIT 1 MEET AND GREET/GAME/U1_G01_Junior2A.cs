...
[Serializable]
public class U1_G01_Junior2A_QuestionData
{
...
public class U1_G01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    ...
    [SerializeField] U1_G01_Junior2A_QuestionData[] _questionData; // Fixed class type match naming
    ...
    {
        foreach (U1_G01_Junior2A_QuestionData item in _questionData)
        {
            ...
            else
            {
                ...
                _selectedButton.GetComponent<WiggleEffect_Junior2A>().enabled = true;
            }
        ...
        {
            _starsPanel.transform.GetChild(i).GetComponent<PopEffect_Junior2A>().enabled = true;
