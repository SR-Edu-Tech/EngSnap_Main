...
public class U10_RWD_Junior2A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "GUIDING STAR UNIT 10 COMPLETED, YOUR TEACHER IS NOW PROUD";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
