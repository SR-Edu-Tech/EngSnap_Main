...
[Serializable]
public class U9_G01_Junior2A_QuestionData
{
...
public class U9_G01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    ...
    [SerializeField] U9_G01_Junior2A_QuestionData[] _questionData;
    ...
    IEnumerator MoveFish()
    {
        ...
        foreach (U9_G01_Junior2A_QuestionData item in _questionData)
        {
