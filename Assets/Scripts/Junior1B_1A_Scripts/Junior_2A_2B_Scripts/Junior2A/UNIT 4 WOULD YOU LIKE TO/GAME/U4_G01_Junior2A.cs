...
public class U4_G01_Junior2A_QuestionData
{
...
public class U4_G01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    ...
    [SerializeField] U4_G01_Junior2A_QuestionData[] _questionData;
    ...
    {
        foreach (U4_G01_Junior2A_QuestionData item in _questionData)
        {
