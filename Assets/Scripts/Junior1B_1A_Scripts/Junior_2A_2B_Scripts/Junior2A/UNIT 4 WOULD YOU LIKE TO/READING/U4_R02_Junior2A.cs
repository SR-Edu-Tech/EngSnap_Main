...
[Serializable]
public class U4_R02_TabAudioData
{
    public AudioClip[] QuestionClips;
    public AudioClip[] ResponseClips;
}

public class U4_R02_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    [SerializeField] AudioSource _audioSource;
    [SerializeField] AudioClip _introClip;

    [Header("Tab Specific Audio Data (6 Elements)")]
    [SerializeField] U4_R02_TabAudioData[] _tabAudioData;
    ...
    [Header("Score Tracking UI")]
    [SerializeField] TextMeshProUGUI _clickedIndexText; // Drag your TextMeshPro score tracker here
    ...
    IEnumerator Starter()
    {
        ...
        if (_clickedIndexText != null) _clickedIndexText.text = "0/6";
    ...
    public void playaudio()
    {
        ...
        _audioCoroutine = StartCoroutine(PlaySequencedAudio(_lastActiveIndex));
    }
    ...
    IEnumerator MoveTab(int index)
    {
        ...
        // Track unique button clicks and update the score string dynamically
        if (!_clickCheckIndex.Contains(index))
        {
            _clickCheckIndex.Add(index);
            if (_clickedIndexText != null)
            {
                _clickedIndexText.text = _clickCheckIndex.Count.ToString() + "/6";
            }
        }
