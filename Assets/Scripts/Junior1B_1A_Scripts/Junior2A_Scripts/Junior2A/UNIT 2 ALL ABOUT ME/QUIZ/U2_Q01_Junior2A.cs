...
[Serializable]
public class U2_Q01_Junior2A_QuestionData
{
...
public class U2_Q01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    [SerializeField] AudioSource _audioSource;
    [SerializeField] AudioClip _introClip, _wrongClip, _correctClip;
    [SerializeField] U2_Q01_Junior2A_QuestionData[] _questions;
    ...
    IEnumerator CheckAnswer(int index)
    {
        ...
        else
        {
            ...
            _buttonParent.transform.GetChild(index).GetComponent<WiggleEffect_Junior2A1>().enabled = true;
        ...
        if (_currentQuestionIndex < _questions.Length - 1)
        {
            ...
            // Image target conditional checks removed here to prevent activation on question index 2
