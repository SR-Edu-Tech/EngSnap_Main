...
public class U3_RWD_Junior2A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "GOOD JOB FINISHING UNIT 3, CONVERSATION CHAMPION";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
