...
public class U1_RWD_Junior2A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "MEET AND GREET FINISHED, YOU COMPELTED UNIT 1!!";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
