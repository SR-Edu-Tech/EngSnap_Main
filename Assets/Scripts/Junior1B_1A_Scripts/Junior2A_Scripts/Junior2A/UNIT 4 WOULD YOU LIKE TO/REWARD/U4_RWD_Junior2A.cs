...
public class U4_RWD_Junior2A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "WOULD YOU LIKE TO OCEAN CHAMPION UNIT 4 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
