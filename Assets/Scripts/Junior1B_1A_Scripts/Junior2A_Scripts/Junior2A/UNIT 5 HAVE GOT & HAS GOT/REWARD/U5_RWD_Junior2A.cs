...
public class U5_RWD_Junior2A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "HAVE GOT & HAS GOT? OCEAN CHAMPION UNIT 5 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
