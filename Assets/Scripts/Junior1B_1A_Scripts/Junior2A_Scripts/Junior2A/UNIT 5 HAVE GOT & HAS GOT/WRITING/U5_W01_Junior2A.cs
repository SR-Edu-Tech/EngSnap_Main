...
[Serializable]
public class U5_W01_Junior2A_QuestionData
{
...
public class U5_W01_Junior2A : MonoBehaviour, Interfaces_Junior2A
{
    ...
    [SerializeField] U5_W01_Junior2A_QuestionData[] _questionData;
    ...
    IEnumerator CheckDataValidity()
    {
        ...
        else
        {
            ...
            if (GetComponent<WiggleEffect_Junior2A1>() != null) GetComponent<WiggleEffect_Junior2A1>().enabled = true;
            else if (_answerBox.GetComponent<WiggleEffect_Junior2A1>() != null) _answerBox.GetComponent<WiggleEffect_Junior2A1>().enabled = true;
