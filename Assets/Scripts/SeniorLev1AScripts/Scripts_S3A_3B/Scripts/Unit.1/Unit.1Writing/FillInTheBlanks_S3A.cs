...
public class FillInTheBlanks_S3A : MonoBehaviour
{
    [System.Serializable]
    ...
    public float questionTextPopDuration = 1.2f;
    public float questionTextCharStagger = 0.04f;
    public float questionTextPopAmplitude = 0.6f;
    public float questionTextPopFrequency = 4f;
    ...
    private Vector3 boardOrigScale;
    private Vector3 optionsOrigScale;
    void Awake()
    {
    ...
    boardOrigScale = board.localScale;
    optionsOrigScale = optionsContainer.localScale;
    }
    ...
    IEnumerator IntroFlow()
    {
        ...
        foreach (var t in boardTexts)
        {
            ...
            questionTextPopDuration,
            questionTextCharStagger,
            questionTextPopAmplitude,
            questionTextPopFrequency));
        }
    ...
    void ShowResult()
    {
        ...
        foreach (var s in slots)
        {
            if (s.currentValue == s.correctAnswer)
                correctCount++;
        }
