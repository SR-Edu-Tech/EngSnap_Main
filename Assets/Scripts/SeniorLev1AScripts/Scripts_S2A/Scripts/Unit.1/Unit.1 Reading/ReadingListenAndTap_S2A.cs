...
public class ReadingListenAndTap_S2A : MonoBehaviour
{
    [System.Serializable]
    public class Option
    {
    ...
    void ResetGame()
    {
        ...
        foreach (var opt in options)
        {
            ...
            if (opt.label != null)
            {
                ...
                CanvasGroup cg = opt.label.GetComponent<CanvasGroup>();
                if (cg == null) cg = opt.label.gameObject.AddComponent<CanvasGroup>();
                cg.alpha = 0f;
            }
            ...
            if (opt.extraLabel != null)
            {
                ...
                CanvasGroup ecg = opt.extraLabel.GetComponent<CanvasGroup>();
                if (ecg == null) ecg = opt.extraLabel.gameObject.AddComponent<CanvasGroup>();
                ecg.alpha = 0f;
            }
