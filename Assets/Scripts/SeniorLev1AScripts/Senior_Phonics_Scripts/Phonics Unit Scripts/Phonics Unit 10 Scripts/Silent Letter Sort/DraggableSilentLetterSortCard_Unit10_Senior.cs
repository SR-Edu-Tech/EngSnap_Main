...
public class DraggableSilentLetterSortCard_Unit10_Senior : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    private SilentLetterSort_Unit10_Senior manager;
    private RectTransform rectTransform;
    private Canvas canvas;
    private bool wasDragged = false;

    public void Setup(SilentLetterSort_Unit10_Senior m)
    {
        manager = m;
