...
public class DraggableCSortCard_P_Senior : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    private CSort_P_Senior manager;
    private RectTransform rectTransform;
    private Canvas canvas;
    private bool wasDragged = false;

    public void Setup(CSort_P_Senior m)
    {
        manager = m;
