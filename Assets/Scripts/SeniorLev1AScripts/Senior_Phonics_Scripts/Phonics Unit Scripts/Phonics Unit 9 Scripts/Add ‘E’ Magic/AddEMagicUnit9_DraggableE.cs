...
public class AddEMagicUnit9_DraggableE : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    [Header("Settings")]
    [SerializeField] private float dragScaleFactor = 1.1f;
    [SerializeField] private float returnDuration = 0.3f;

    private AddEMagicUnit9_Senior manager;
    ...
    public void Setup(AddEMagicUnit9_Senior mgr)
    {
        manager = mgr;
        EnsureInitialized();
    }
