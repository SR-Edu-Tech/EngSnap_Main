...
public class Masters_LineDragToExpressionMatch_SelfIntroduction : MonoBehaviour {


    [SerializeField]
    private Masters_SelfIntroduction_Game_LessonOne.LeftOrRightPhrase leftOrRightPhrase;
    [SerializeField]
    ...
    public Masters_SelfIntroduction_Game_LessonOne.LeftOrRightPhrase GetLeftOrRightPhrase() {
