...
public class Masters_LineDragToExpressionMatch_CorrectPronunciation : MonoBehaviour {


    [SerializeField]
    private Masters_CorrectPronunciation_Game_LessonOne.LeftOrRightPhrase leftOrRightPhrase;
    [SerializeField]
    ...
    public Masters_CorrectPronunciation_Game_LessonOne.LeftOrRightPhrase GetLeftOrRightPhrase() {
