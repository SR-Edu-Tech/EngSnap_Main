...
public class Masters_SortPhraseCard_LetsChoose : MonoBehaviour {
    ...
    public void SetSortTypeAndExpression(Masters_LetsChoose_Listening_LessonTwo.SortType sortType, string expression) {
