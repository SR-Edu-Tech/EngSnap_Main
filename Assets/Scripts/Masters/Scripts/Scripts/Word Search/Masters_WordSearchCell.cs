...
public class Masters_WordSearchCell : MonoBehaviour,
    IPointerDownHandler, IPointerUpHandler
{
    ...
    private Masters_WordSearchManager manager;

    public void Init(int r, int c, char l, Masters_WordSearchManager m)
    {
        row     = r;
        col     = c;
        letter  = l;
