...
//
public class Masters_TopicItemUI : MonoBehaviour
{
    [Header("References")]
    ...
    private Masters_WordTopicData data;
    private Masters_WordMatchTopicSelectionManager manager;

    public void Init(Masters_WordTopicData topicData, Masters_WordMatchTopicSelectionManager mgr)
    {
        data    = topicData;
        manager = mgr;
