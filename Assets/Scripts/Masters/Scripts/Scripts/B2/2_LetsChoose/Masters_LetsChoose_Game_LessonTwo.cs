...
public class Masters_LetsChoose_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField] private Masters_LetsChoose_MemoryTile memoryTilePrefab;
    ...
    private List<Masters_LetsChoose_MemoryTile> allTiles = new List<Masters_LetsChoose_MemoryTile>();
    private Masters_LetsChoose_MemoryTile firstSelectedTile;
    private Masters_LetsChoose_MemoryTile secondSelectedTile;
    ...
    private void SetupTiles() {
        ...
        foreach (var item in itemsToSpawn) {
            Masters_LetsChoose_MemoryTile newTile = Instantiate(memoryTilePrefab, tilesContainer);
    ...
    public void TileSelected(Masters_LetsChoose_MemoryTile selectedTile) {
