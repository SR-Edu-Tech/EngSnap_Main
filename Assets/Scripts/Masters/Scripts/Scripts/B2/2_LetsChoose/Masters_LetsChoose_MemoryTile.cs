...
public class Masters_LetsChoose_MemoryTile : MonoBehaviour
{
    ...
    private Masters_LetsChoose_Game_LessonTwo gameController;
    private bool isMatched = false;
    private bool isOpen = false;

    public void Setup(string id, string displayText, Masters_LetsChoose_Game_LessonTwo controller)
    {
        matchId = id;
