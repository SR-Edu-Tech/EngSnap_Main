...
public class Masters_LetsChoose_Listening_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_LetsChoose sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_LetsChoose[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_LetsChoose sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_LetsChoose sortBin) {
        if (!canClick) {
            return;
        }
