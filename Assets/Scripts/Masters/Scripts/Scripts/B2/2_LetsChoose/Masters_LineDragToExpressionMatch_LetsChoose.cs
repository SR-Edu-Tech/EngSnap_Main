...
public class Masters_LineDragToExpressionMatch_LetsChoose : MonoBehaviour {


    [SerializeField]
    private Masters_LetsChoose_Reading_LessonTwo.LeftOrRightPhrase leftOrRightPhrase;
    [SerializeField]
    ...
    public Masters_LetsChoose_Reading_LessonTwo.LeftOrRightPhrase GetLeftOrRightPhrase() {
