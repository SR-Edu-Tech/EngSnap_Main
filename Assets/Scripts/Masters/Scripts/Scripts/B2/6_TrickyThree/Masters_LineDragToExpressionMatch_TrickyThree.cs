...
public class Masters_LineDragToExpressionMatch_TrickyThree : MonoBehaviour {


    [SerializeField]
    private Masters_TrickyThree_Reading_LessonOne.LeftOrRightPhrase leftOrRightPhrase;
    [SerializeField]
    ...
    public Masters_TrickyThree_Reading_LessonOne.LeftOrRightPhrase GetLeftOrRightPhrase() {
