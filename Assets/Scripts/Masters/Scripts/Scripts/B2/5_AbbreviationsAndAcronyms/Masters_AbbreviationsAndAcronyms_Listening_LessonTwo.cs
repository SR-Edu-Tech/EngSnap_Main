...
public class Masters_AbbreviationsAndAcronyms_Listening_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_AbbreviationsAndAcronyms sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_AbbreviationsAndAcronyms[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_AbbreviationsAndAcronyms sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_AbbreviationsAndAcronyms sortBin) {
        if (!canClick) {
            return;
        }
