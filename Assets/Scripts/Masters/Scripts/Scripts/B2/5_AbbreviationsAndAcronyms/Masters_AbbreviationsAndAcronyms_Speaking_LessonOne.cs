...
public class Masters_AbbreviationsAndAcronyms_Speaking_LessonOne : Masters_Lesson {
    ...
    public class SpeechToText {
        ...
        public string speakingModeText;
    ...
    [SerializeField]
    private TextMeshProUGUI speakingModeTMP;
    [SerializeField]
    ...
    private void SetPhraseCardAndSpeechToText() {
        ...
        if (speakingModeTMP != null) {
            speakingModeTMP.text = currentSpeechToText.speakingModeText;
        }
