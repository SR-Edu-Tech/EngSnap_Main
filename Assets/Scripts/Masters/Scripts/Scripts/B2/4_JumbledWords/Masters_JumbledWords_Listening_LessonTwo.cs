...
public class Masters_JumbledWords_Listening_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_JumbledWords sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_JumbledWords[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_JumbledWords sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_JumbledWords sortBin) {
        if (!canClick) {
            return;
        }
