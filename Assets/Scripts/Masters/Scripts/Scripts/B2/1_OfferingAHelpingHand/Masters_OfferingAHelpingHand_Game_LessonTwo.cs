...
public class Masters_OfferingAHelpingHand_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField] private Masters_OfferingAHelpingHand_MemoryTile memoryTilePrefab;
    ...
    private List<Masters_OfferingAHelpingHand_MemoryTile> allTiles = new List<Masters_OfferingAHelpingHand_MemoryTile>();
    private Masters_OfferingAHelpingHand_MemoryTile firstSelectedTile;
    private Masters_OfferingAHelpingHand_MemoryTile secondSelectedTile;
    ...
    private void SetupTiles() {
        ...
        foreach (var item in itemsToSpawn) {
            Masters_OfferingAHelpingHand_MemoryTile newTile = Instantiate(memoryTilePrefab, tilesContainer);
    ...
    public void TileSelected(Masters_OfferingAHelpingHand_MemoryTile selectedTile) {
    ...
    private void ShowQuizCompleteScreen() {
        ...
        // Light up all stars on completion
        if (starImageArray != null) {
            foreach (Image star in starImageArray) {
                if (star != null) star.color = goldStarColor;
            }
        }
