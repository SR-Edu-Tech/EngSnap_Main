...
public class Masters_LineDragToExpressionMatch_OfferingAHelpingHand : MonoBehaviour {


    [SerializeField]
    private Masters_OfferingAHelpingHand_Reading_LessonTwo.LeftOrRightPhrase leftOrRightPhrase;
    [SerializeField]
    ...
    public Masters_OfferingAHelpingHand_Reading_LessonTwo.LeftOrRightPhrase GetLeftOrRightPhrase() {
