...
public class Masters_SituationalDialogues_Listening_LessonOne : Masters_Lesson {
    ...
    private void OnDialogueSetButtonClicked(RectTransform rectTransform, DialogueSet dialogueSet) {
        ...
        PlayDialogueLineByLine(dialogueSet);
        Vector2 contentPosition = dialogueSet.contentRectTransform.anchoredPosition;
        contentPosition.y = 0f;
        dialogueSet.contentRectTransform.anchoredPosition = contentPosition;
    }
