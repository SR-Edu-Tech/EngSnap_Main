...
public class Masters_YouAreInvited_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_YouAreInvited sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_YouAreInvited[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_YouAreInvited sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_YouAreInvited sortBin) {
        if (!canClick) {
            return;
        }
