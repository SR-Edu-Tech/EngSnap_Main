...
public class Masters_SelfIntroduction_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_SelfIntroduction sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_SelfIntroduction[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_SelfIntroduction sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_SelfIntroduction sortBin) {
        if (!canClick) {
            return;
        }
