...
public class Masters_WowCompliments_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_WowExpressions sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_WowExpressions[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_WowExpressions sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_WowExpressions sortBin) {
        if (!canClick) {
            return;
        }
