...
public class Masters_CorrectPronunciation_Listening_LessonTwo : Masters_Lesson {
    ...
    private void OnPhraseCardButtonClicked(PhraseCard phraseCard) {
        ...
        if (!phraseCardHashSet.Contains(phraseCard)) {
            ...
            expressionCountTMP.text = $"{phraseCardHashSet.Count}/11";

            if (phraseCardHashSet.Count == 11) {
