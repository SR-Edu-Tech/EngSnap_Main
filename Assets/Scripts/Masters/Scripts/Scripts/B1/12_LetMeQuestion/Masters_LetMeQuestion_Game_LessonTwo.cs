...
public class Masters_LetMeQuestion_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_LetMeQuestion sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_LetMeQuestion[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_LetMeQuestion sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_LetMeQuestion sortBin) {
        if (!canClick) {
            return;
        }
