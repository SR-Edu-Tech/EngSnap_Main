...
public class Masters_AnnounceAndRespondToUnfortunateNews_Writing_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private TextMeshProUGUI situationTMP;
    [SerializeField]
    ...
    private void ClearAndSetPuzzle() {
        ...
        situationTMP.gameObject.SetActive(false);
        situationTMP.text = currentArrangeWordsPuzzle.situationText;
