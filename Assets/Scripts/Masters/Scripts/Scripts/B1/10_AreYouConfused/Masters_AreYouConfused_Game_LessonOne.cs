...
public class Masters_AreYouConfused_Game_LessonOne : Masters_Lesson, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    private Masters_LineDragToExpressionMatch_AreYouConfused startLineDragToExpressionMatch;
    private int correctCount;


    public void OnBeginDrag(PointerEventData eventData) {
        if (eventData.pointerPress.TryGetComponent(out Masters_LineDragToExpressionMatch_AreYouConfused lineDragToExpressionMatch) &&
    ...
    public void OnEndDrag(PointerEventData eventData) {
        ...
        if (eventData.pointerCurrentRaycast.gameObject.TryGetComponent(out Masters_LineDragToExpressionMatch_AreYouConfused
