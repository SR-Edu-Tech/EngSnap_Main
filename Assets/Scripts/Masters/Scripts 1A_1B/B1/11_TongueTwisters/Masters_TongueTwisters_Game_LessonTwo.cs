...
public class Masters_TongueTwisters_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_TongueTwisters sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_TongueTwisters[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_TongueTwisters sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_TongueTwisters sortBin) {
        if (!canClick) {
            return;
        }
