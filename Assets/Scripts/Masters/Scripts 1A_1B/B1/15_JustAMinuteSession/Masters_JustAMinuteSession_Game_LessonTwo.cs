...
public class Masters_JustAMinuteSession_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_JustAMinuteSession sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_JustAMinuteSession[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_JustAMinuteSession sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_JustAMinuteSession sortBin) {
        if (!canClick) {
            return;
        }
