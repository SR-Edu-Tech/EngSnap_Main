...
public class Masters_MyLearningHub_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_MyLearningHub sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_MyLearningHub[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_MyLearningHub sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_MyLearningHub sortBin) {
        if (!canClick) {
            return;
        }
