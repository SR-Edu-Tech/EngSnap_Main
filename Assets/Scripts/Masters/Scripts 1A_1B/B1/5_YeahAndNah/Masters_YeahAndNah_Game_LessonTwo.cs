...
public class Masters_YeahAndNah_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_YeahAndNah sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_YeahAndNah[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_YeahAndNah sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_YeahAndNah sortBin) {
        if (!canClick) {
            return;
        }
