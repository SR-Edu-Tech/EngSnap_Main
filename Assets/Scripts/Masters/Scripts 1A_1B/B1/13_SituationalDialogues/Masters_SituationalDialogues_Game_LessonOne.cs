...
public class Masters_SituationalDialogues_Game_LessonOne : Masters_Lesson, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    private Masters_LineDragToExpressionMatch_SituationalDialogues startLineDragToExpressionMatch;
    private int correctCount;


    public void OnBeginDrag(PointerEventData eventData) {
        if (eventData.pointerPress.TryGetComponent(out Masters_LineDragToExpressionMatch_SituationalDialogues lineDragToExpressionMatch) &&
    ...
    public void OnEndDrag(PointerEventData eventData) {
        ...
        if (eventData.pointerCurrentRaycast.gameObject.TryGetComponent(out Masters_LineDragToExpressionMatch_SituationalDialogues
