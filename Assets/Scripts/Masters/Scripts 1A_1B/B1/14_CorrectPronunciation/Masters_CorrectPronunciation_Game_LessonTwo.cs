...
public class Masters_CorrectPronunciation_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_CorrectPronunciation sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_CorrectPronunciation[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_CorrectPronunciation sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_CorrectPronunciation sortBin) {
        if (!canClick) {
            return;
        }
