...
public class Masters_CorrectPronunciation_Game_LessonOne : Masters_Lesson, IDragHandler, IBeginDragHandler, IEndDragHandler {
    ...
    private Masters_LineDragToExpressionMatch_CorrectPronunciation startLineDragToExpressionMatch;
    private int correctCount;


    public void OnBeginDrag(PointerEventData eventData) {
        if (eventData.pointerPress.TryGetComponent(out Masters_LineDragToExpressionMatch_CorrectPronunciation lineDragToExpressionMatch) &&
    ...
    public void OnEndDrag(PointerEventData eventData) {
        ...
        if (eventData.pointerCurrentRaycast.gameObject.TryGetComponent(out Masters_LineDragToExpressionMatch_CorrectPronunciation
