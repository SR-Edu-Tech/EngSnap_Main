...
public class Masters_MeetingAndGreeting_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_MeetingAndGreeting sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_MeetingAndGreeting[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach(Masters_SortBin_MeetingAndGreeting sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_MeetingAndGreeting sortBin) {
        if (!canClick) {
            return;
        }
