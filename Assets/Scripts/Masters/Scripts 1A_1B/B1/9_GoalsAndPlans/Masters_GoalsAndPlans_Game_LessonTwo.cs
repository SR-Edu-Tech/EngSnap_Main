...
public class Masters_GoalsAndPlans_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_GoalsAndPlans sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_GoalsAndPlans[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_GoalsAndPlans sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_GoalsAndPlans sortBin) {
        if (!canClick) {
            return;
        }
