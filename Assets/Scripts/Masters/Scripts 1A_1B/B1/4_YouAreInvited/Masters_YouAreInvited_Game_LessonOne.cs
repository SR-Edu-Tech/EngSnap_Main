...
public class Masters_YouAreInvited_Game_LessonOne : Masters_Lesson {
    ...
    private void SetNextQuestion() {
        ...
        statementTMP.text = currentQuestion.invitation;
        questionTMP.text = currentQuestion.situation;
        ...
        statementTextTypeWriter.TriggerAnimation(currentQuestion.invitation.Length);
        questionTextTypeWriter.TriggerAnimation(currentQuestion.situation.Length);
