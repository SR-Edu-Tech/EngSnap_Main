...
public class Masters_AnnounceAndRespondToUnfortunateNews_Game_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_AnnounceAndRespondToUnfortunateNews sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_AnnounceAndRespondToUnfortunateNews[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_AnnounceAndRespondToUnfortunateNews sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_AnnounceAndRespondToUnfortunateNews sortBin) {
        if (!canClick) {
            return;
        }
        ...
        if (sortBin.GetSortType() == currentSortPuzzle.sortType) {
            ...
            puzzleCountTMP.text = $"{currentSortPuzzleIndex}/8";
            canClick = false;
