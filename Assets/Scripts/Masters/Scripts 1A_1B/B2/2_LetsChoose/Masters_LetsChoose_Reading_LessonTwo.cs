...
public class Masters_LetsChoose_Reading_LessonTwo : Masters_Lesson, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    private Masters_LineDragToExpressionMatch_LetsChoose startLineDragToExpressionMatch;
    private int correctCount;


    public void OnBeginDrag(PointerEventData eventData) {
        if (eventData.pointerPress.TryGetComponent(out Masters_LineDragToExpressionMatch_LetsChoose lineDragToExpressionMatch) &&
    ...
    public void OnEndDrag(PointerEventData eventData) {
        ...
        if (eventData.pointerCurrentRaycast.gameObject.TryGetComponent(out Masters_LineDragToExpressionMatch_LetsChoose lineDragToExpressionMatch) && lineDragToExpressionMatch.GetLeftOrRightPhrase() == LeftOrRightPhrase.Right) {
