...
public class Masters_ChangeVoiceAndSoundSmart_Speaking_LessonOne : Masters_Lesson {
    ...
    private void SetQuestionState() {
        ...
        // Hide answer and reset Hint button
    ...
    private void OnSpeechResult(string spokenText) {
        ...
        if (maxSimilarity > 0.75) {
            ...
            // Hide answer text field again upon correct completion
            if (answerPanel != null) answerPanel.SetActive(false);
            if (hintButton != null) hintButton.interactable = false;
