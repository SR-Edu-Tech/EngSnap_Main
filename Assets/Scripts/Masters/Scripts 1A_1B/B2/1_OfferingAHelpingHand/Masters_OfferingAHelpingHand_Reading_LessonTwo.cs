...
public class Masters_OfferingAHelpingHand_Reading_LessonTwo : Masters_Lesson, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    private Masters_LineDragToExpressionMatch_OfferingAHelpingHand startLineDragToExpressionMatch;
    private int correctCount;


    public void OnBeginDrag(PointerEventData eventData) {
        if (eventData.pointerPress.TryGetComponent(out Masters_LineDragToExpressionMatch_OfferingAHelpingHand lineDragToExpressionMatch) &&
    ...
    public void OnEndDrag(PointerEventData eventData) {
        ...
        if (eventData.pointerCurrentRaycast.gameObject.TryGetComponent(out Masters_LineDragToExpressionMatch_OfferingAHelpingHand lineDragToExpressionMatch) && lineDragToExpressionMatch.GetLeftOrRightPhrase() == LeftOrRightPhrase.Right) {
