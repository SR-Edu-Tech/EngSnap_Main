...
public class Masters_OfferingAHelpingHand_Listening_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_OfferingAHelpingHand sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_OfferingAHelpingHand[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_OfferingAHelpingHand sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_OfferingAHelpingHand sortBin) {
        if (!canClick) {
            return;
        }
