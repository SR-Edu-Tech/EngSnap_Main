...
public class Masters_TrickyThree_Reading_LessonThree : Masters_Lesson {
    ...
    private IEnumerator PopUpAnimationAndLoadFirstQuestion() {
        if (questionTMP != null) questionTMP.transform.localScale = Vector3.zero;
        ...
        if (questionTMP != null) {
            ...
            questionTMP.transform.DOScale(Vector3.one, animationSpeed).SetEase(Ease.OutBack);
        }
