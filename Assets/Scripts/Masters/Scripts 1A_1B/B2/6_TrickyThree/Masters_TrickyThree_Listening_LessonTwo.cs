...
public class Masters_TrickyThree_Listening_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_TrickyThree sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_TrickyThree[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_TrickyThree sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_TrickyThree sortBin) {
        if (!canClick) {
            return;
        }
