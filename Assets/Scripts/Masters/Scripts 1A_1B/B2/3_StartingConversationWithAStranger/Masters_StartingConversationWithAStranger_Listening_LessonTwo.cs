...
public class Masters_StartingConversationWithAStranger_Listening_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    private Masters_SortPhraseCard_StartingConversationWithAStranger sortPhraseCard;
    [SerializeField]
    private SortPuzzle[] sortPuzzleArray;
    [SerializeField]
    private Masters_SortBin_StartingConversationWithAStranger[] sortBinArray;
    [SerializeField]
    ...
    protected override void Awake() {
        ...
        foreach (Masters_SortBin_StartingConversationWithAStranger sortBin in sortBinArray) {
    ...
    private void OnSortBinClicked(Masters_SortBin_StartingConversationWithAStranger sortBin) {
        if (!canClick) {
            return;
        }
