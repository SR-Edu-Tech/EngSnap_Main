...
public class Masters_StartingConversationWithAStranger_MemoryTile : MonoBehaviour
{
    ...
    private Masters_StartingConversationWithAStranger_Game_LessonTwo gameController;
    private bool isMatched = false;
    private bool isOpen = false;

    public void Setup(string id, string displayText, Masters_StartingConversationWithAStranger_Game_LessonTwo controller)
    {
        matchId = id;
