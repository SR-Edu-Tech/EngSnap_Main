...
public class Masters_SortPhraseCard_CorrectPronunciation : MonoBehaviour {
    ...
    public void SetSortTypeAndExpression(Masters_CorrectPronunciation_Game_LessonTwo.SortType sortType, string expression) {
