...
public class Masters_SortPhraseCard_GoalsAndPlans : MonoBehaviour {
    ...
    public void SetSortTypeAndExpression(Masters_GoalsAndPlans_Game_LessonTwo.SortType sortType, string expression) {
