...
public class Masters_SortPhraseCard_SelfIntroduction : MonoBehaviour {
    ...
    public void SetSortTypeAndExpression(Masters_SelfIntroduction_Game_LessonTwo.SortType sortType, string expression) {
