...
/// <summary>
/// Unit 5 (Doctor Need Your Help): Roleplay Lesson One (RP01: On Stage — At the Doctor).
...
/// </summary>
public class Masters_DoctorNeedYourHelp_Roleplay_LessonOne : Masters_PolishedCommunication_Roleplay_LessonOne {
    ...
    private void UpdateTitleAndHeader() {
        ...
        foreach (var tmp in allTMPs) {
            ...
            if (lowerName.Contains("lessontitle") || lowerName.Contains("title") || textVal.Contains("STAGE") || textVal.Contains("Polished") || textVal.Contains("Clarify") || textVal.Contains("Greet") || textVal.Contains("Noisy") || textVal.Contains("Jammy") || textVal.Contains("Helping") || textVal.Contains("Conversation") || textVal.Contains("Act") || textVal.Contains("Doctor")) {
                tmp.text = "RP01 On Stage — At the Doctor";
            }
