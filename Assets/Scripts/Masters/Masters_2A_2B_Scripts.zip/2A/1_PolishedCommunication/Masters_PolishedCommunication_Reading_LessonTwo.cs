...
public class Masters_PolishedCommunication_Reading_LessonTwo : Masters_Lesson, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    [Header("Match Setup")]
    [SerializeField] protected MatchPuzzle[] puzzles;
    [SerializeField] protected Masters_UniversalLineDragMatch leftMatchNodePrefab;
    [SerializeField] protected Masters_UniversalLineDragMatch rightMatchNodePrefab;
    [SerializeField] protected Transform leftContainer;
    [SerializeField] protected Transform rightContainer;
    [SerializeField] protected bool useUniqueRightCards = true; // True = 2 cards on right (FORMAL & INFORMAL)
    [SerializeField] protected int pairsPerSet = 4; // Splits 8 puzzles into 2 pages of 4 items each

    [SerializeField] protected RectTransform puzzleContainerRectTransform;
    ...
    protected int correctCountInCurrentSet = 0;
    protected int currentSetExpectedPairs = 0;
    ...
    protected virtual void LoadNextSet() {
    ...
    protected virtual void OnLessonSuccess() {
        if (nextButton != null) {
