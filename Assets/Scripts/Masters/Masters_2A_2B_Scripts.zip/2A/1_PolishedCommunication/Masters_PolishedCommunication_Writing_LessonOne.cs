...
public class Masters_PolishedCommunication_Writing_LessonOne : Masters_Lesson {
    ...
    [SerializeField]
    protected TextMeshProUGUI promptTMP;
    [SerializeField]
    ...
    [SerializeField]
    protected GameObject hintPanel;
    [SerializeField]
    protected TextMeshProUGUI hintTMP;

    [Header("Settings & Visual Feedback")]
    [SerializeField]
    protected float timeBetweenQuestions = 1.5f;
    [SerializeField]
    protected Color correctColor = Color.green;
    [SerializeField]
    protected Color incorrectColor = Color.red;
    [SerializeField]
    protected Color defaultInputFieldColor = Color.white;
    [SerializeField]
    protected Image inputFieldBackground;
