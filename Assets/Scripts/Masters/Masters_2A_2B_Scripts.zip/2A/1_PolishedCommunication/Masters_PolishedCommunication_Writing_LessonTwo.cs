...
public class Masters_PolishedCommunication_Writing_LessonTwo : Masters_Lesson {
    ...
    [SerializeField]
    protected TextMeshProUGUI npcSpeechBubbleTMP;
    [SerializeField]
    protected Masters_TextTypeWriter npcSpeechTypeWriter;
    [SerializeField]
    protected TMP_InputField studentInputField;
    [SerializeField]
    protected Image studentInputFieldBackgroundImage;
    [SerializeField]
    protected Button[] starterChipButtons;
    [SerializeField]
    protected TextMeshProUGUI[] starterChipTMPs;
    [SerializeField]
    protected Button submitButton;

    [Header("Color")]
    [SerializeField]
    protected Color defaultInputColor = Color.white;
    [SerializeField]
    protected Color correctInputColor = Color.green;
    [SerializeField]
    protected Color incorrectInputColor = Color.red;
