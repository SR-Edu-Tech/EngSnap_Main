...
public class Masters_PolishedCommunication_Listening_LessonOne : Masters_Lesson {
    ...
    [SerializeField] protected RegisterQuestionData[] questions;
    [SerializeField] protected Button[] optionButtons; // Index 0: FORMAL, Index 1: INFORMAL
    [SerializeField] protected TextMeshProUGUI progressTMP;
    [SerializeField] protected float animationSpeed = 0.4f;
    [SerializeField] protected int passThreshold = 8;

    [Header("Audio Toggles")]
    [SerializeField] protected Toggle slowToggle;
    [SerializeField] protected Toggle repeatToggle;

    [Header("Navigation")]
    [SerializeField] protected Masters_LessonSO nextLessonSO;

    protected int currentQuestionIndex = 0;
    protected int correctScore = 0;
    ...
    private void AutoLoadSlowAudioInEditor() {
        ...
        for (int i = 0; i < questions.Length; i++) {
            if (questions[i] != null && questions[i].slowAudio == null && questions[i].expressionAudio != null) {
                ...
                AudioClip clip = null;
        #if UNITY_EDITOR
        clip = UnityEditor.AssetDatabase.LoadAssetAtPath<AudioClip>(slowPath);
#endif
                if (clip != null) {
    ...
    protected virtual void ConfigureOptionButtons() {
        if (optionButtons != null && optionButtons.Length > 0 && optionButtons[0] != null) {
    ...
    protected virtual void SetButtonText(Button btn, string text) {
        if (btn == null) return;
    ...
    protected virtual void OnOptionSelected(int buttonIndex) {
    ...
    protected virtual IEnumerator NextQuestionRoutine() {
