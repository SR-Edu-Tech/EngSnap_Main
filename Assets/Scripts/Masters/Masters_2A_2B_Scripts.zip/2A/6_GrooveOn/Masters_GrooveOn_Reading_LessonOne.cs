...
public class R01RoundData {
    ...
    private void OnValidate() {
        if (!Application.isPlaying) {
            ...
            if (!UnityEditor.PrefabUtility.IsPartOfPrefabAsset(this)) {
                EnsureOptionCardsExistInEditor();
            }
        }
    }
    ...
    public void EnsureOptionCardsExistInEditor() {
        ...
        string[] defaultTexts = new string[] {
            ...
            "Where is the party happening tonight?",
        ...
        for (int i = 0; i < 4; i++) {
            ...
            outerBorderImg.color = new Color(0.745f, 0.831f, 0.835f, 1.0f);
            ...
            if (textT == null) {
                ...
                if (textGo.transform.parent != fillGo.transform) {
                    textGo.transform.SetParent(fillGo.transform, false);
                }
            }
