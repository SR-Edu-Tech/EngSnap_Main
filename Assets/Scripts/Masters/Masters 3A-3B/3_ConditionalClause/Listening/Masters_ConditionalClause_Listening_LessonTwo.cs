...
/// <summary>
/// Core Listening 2 controller for Book 3A Unit 3: Conditional Clause (Cheer the Pal — Situation + 3 Replies).
...
/// </summary>
public class Masters_ConditionalClause_Listening_LessonTwo : Masters_Lesson {
