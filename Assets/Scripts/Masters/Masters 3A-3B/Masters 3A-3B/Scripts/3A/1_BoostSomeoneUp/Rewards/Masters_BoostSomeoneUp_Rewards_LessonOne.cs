...
/// <summary>
/// Core Game Manager for Unit 1: Boost Someone Up! - Rewards Lesson One (R01).
/// Adapted from Book 2A PolishedCommunication Rewards L1.
...
/// </summary>
public class Masters_BoostSomeoneUp_Rewards_LessonOne : Masters_Lesson {
