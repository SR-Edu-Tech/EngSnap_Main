...
/// <summary>
/// Core Listening 1 controller for Book 3A Unit 1: Boost Someone Up! (Hear It — 3 Bins Sort).
...
/// </summary>
public class Masters_BoostSomeoneUp_Listening_LessonOne : Masters_Lesson {
