...
/// <summary>
/// Controls individual memory tiles in Unit 1: Polished Communication - Game Lesson Two (Match Pairs).
/// Standalone Book 2A controller independent of older book scripts.
/// Handles tile states (Open, Closed, Matched) and communicates clicks back to the main game controller.
/// </summary>
public class Masters_PolishedCommunication_MemoryTile : MonoBehaviour {
    ...
    private Masters_PolishedCommunication_Game_LessonTwo gameController;
    ...
    /// </summary>
    public void Setup(string id, string displayText, Masters_PolishedCommunication_Game_LessonTwo controller, bool alwaysShow = false) {
        matchId = id;
