...
/// <summary>
/// Core Game Manager for Unit 1: Polished Communication - Roleplay Lesson One (RP01: On Stage / Greet the Right Way).
/// Standalone Book 2A base controller that simulates a dialogue sequence where an NPC speaks a line and the player picks one of multiple response chips.
/// </summary>
public class Masters_PolishedCommunication_Roleplay_LessonOne : Masters_Lesson {
    ...
    protected virtual void LoadNextRoleplay() {
        ...
        if (currentTurn.npcAudioClip != null && Masters_AudioManager.Instance != null) {
