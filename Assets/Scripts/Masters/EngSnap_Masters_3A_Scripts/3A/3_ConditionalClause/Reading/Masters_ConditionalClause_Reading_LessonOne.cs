...
/// <summary>
/// Core Reading 1 controller for Unit 3: Conditional Clause
/// R01 Match — Line Drag Match (IF -> WILL).
/// </summary>
public class Masters_ConditionalClause_Reading_LessonOne : Masters_Lesson, IBeginDragHandler, IEndDragHandler, IDragHandler {
    ...
    [SerializeField] private bool useUniqueRightCards = false; // False = each right card is unique to the left card
    [SerializeField] private int pairsPerSet = 5;
    ...
    public void InitializePuzzlesIfEmpty() {
        ...
        puzzles = new MatchPuzzle[] {
            new MatchPuzzle { leftPhrase = "If it rains tomorrow,", rightPhrase = "I will stay at home." },
            new MatchPuzzle { leftPhrase = "If she studies well,", rightPhrase = "she will pass the exam." },
            new MatchPuzzle { leftPhrase = "If we have a test next week,", rightPhrase = "I will study for it." },
            new MatchPuzzle { leftPhrase = "If he invites me to the party,", rightPhrase = "I will attend it." },
            new MatchPuzzle { leftPhrase = "If it is cold in the morning tomorrow,", rightPhrase = "I will have a hot water bath." }
        };
    }
