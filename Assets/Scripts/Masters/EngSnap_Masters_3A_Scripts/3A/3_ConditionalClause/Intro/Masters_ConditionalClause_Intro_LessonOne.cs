...
/// <summary>
/// Core Intro controller for Book 3A Unit 3: Conditional Clause.
/// Exact copy of Book 3A Unit 1 Intro with updated class/field names.
...
/// </summary>
public class Masters_ConditionalClause_Intro_LessonOne : Masters_Lesson {
    ...
    [SerializeField] protected string[] formalSentences = new string[0];

    [SerializeField] protected string[] informalSentences = new string[0];
