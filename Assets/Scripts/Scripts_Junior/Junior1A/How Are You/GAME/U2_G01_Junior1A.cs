...
[Serializable]
public class U2_G01_Junior1A_QuestionData
{
    public AudioClip Question;
    public string[] OptionText;
    public int CorrectAnsIndex;
}
public class U2_G01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    [SerializeField] U2_G01_Junior1A_QuestionData[] _questionData;
    ...
    {
        foreach (U2_G01_Junior1A_QuestionData item in _questionData)
        {
