...
public class U2_SP01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    void OnDisable() => CrossPlatformSpeechManager_junior.OnResultStatic -= OnSpeechResult;
    ...
    void ShowTargetWord()
    {
        _currentLineShowBox.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = _questionText[_currentAudioIndex];
