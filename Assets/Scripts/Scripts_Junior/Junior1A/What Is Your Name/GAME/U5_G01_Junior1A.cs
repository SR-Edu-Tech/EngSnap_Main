...
[Serializable]
public class U5_G01_Junior1A_QuestionData
{
    public AudioClip Question;
    public string[] OptionText;
    public int CorrectAnsIndex;
}
public class U5_G01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    [SerializeField] U5_G01_Junior1A_QuestionData[] _questionData;
    ...
    {
        foreach (U5_G01_Junior1A_QuestionData item in _questionData)
        {
