...
[Serializable]
public class U3_G01_Junior1A_QuestionData
{
...
public class U3_G01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    [SerializeField] U3_G01_Junior1A_QuestionData[] _questionData;
    ...
    {
        foreach (U3_G01_Junior1A_QuestionData item in _questionData)
        {
            int _optionIndex = 0;
