...
public class U3_L01_Junior1A : MonoBehaviour, Interfaces_Junior1A
{
    ...
    IEnumerator OnTab()
    {
        ...
        {
            _tab1P.transform.GetChild(_tab1P.transform.childCount - 1).gameObject.SetActive(false);
        ...
        else
        {
            ...
            _tab2P.transform.GetChild(_tab2P.transform.childCount - 1).GetComponent<Image>().sprite = _spriteIndex[_currentSpriteIndex];
            _tab2P.transform.GetChild(_tab2P.transform.childCount - 1).gameObject.SetActive(false);
