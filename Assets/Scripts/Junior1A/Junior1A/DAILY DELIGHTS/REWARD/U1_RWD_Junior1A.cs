...
public class U1_RWD_Junior1A : MonoBehaviour
{
    ...
    IEnumerator Starter()
    {
        ...
        _audioSource.Play();
        _topicObj.transform.GetChild(0).GetComponent<TextMeshProUGUI>().text = "DAILY DELIGHTS OCEAN CHAMPION UNIT 1 COMPLETE";
        _topicObj.SetActive(false);
        _topicObj.SetActive(true);
