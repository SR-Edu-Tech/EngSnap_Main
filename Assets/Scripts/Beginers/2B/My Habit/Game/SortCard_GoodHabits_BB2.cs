...
public enum HabitOrQuality_GoodHabits_BB2 { Habit, Quality }

/// <summary>
/// A single draggable sort card ("I wake up early" / "I will be kind" etc).
/// (Add Component → search "SortCard_GoodHabits_BB2" — drag-and-drop of
/// this file only auto-attaches the file's primary class.)
/// Handles Screen Space - Overlay AND Screen Space - Camera canvases.
/// </summary>
public class SortCard_GoodHabits_BB2 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    [Header("UI Refs")]
    ...
    public HabitOrQuality_GoodHabits_BB2 Category    { get; private set; }
    ...
    public void Initialise(string displayText, HabitOrQuality_GoodHabits_BB2 category, AudioClip cardAudio, Color bgColor)
    {
