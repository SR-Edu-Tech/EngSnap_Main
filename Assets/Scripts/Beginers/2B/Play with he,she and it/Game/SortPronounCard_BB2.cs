...
/// <summary>
/// A single draggable picture card (a boy / a girl / a ball, etc).
/// (Add Component → search "SortPronounCard_BB2" — drag-and-drop of this
/// file only auto-attaches the file's primary class.)
/// Handles Screen Space - Overlay AND Screen Space - Camera canvases.
/// </summary>
public class SortPronounCard_BB2 : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    [Header("UI Refs")]
    public Image    picture;
    public TMP_Text label;

    public PronounWord_Pronouns_BB2 Category  { get; private set; }
    ...
    public void Initialise(Sprite pictureSprite, string labelText, PronounWord_Pronouns_BB2 category, AudioClip cardAudio)
    {
        Category  = category;
        CardAudio = cardAudio;
        IsPlaced  = false;

        if (picture != null) picture.sprite = pictureSprite;
