...
{
    public class MyFirstSentencesController : MonoBehaviour
    {
        [Header("Unit Progress Settings")]
        [SerializeField] private string unitID = "Unit8";
        [SerializeField] private string topicName = "MyFirstSentences";

        [Header("Data Asset")]
        [SerializeField] private MyFirstSentencesData activityData;
        ...
        private void EnsureDataAssigned()
        {
            ...
            {
                activityData = Resources.Load<MyFirstSentencesData>("Phonics2/Unit8/MyFirstSentencesData_Unit8");
            }
            if (activityData == null)
            {
                activityData = ScriptableObject.CreateInstance<MyFirstSentencesData>();
        ...
        private IEnumerator RunPocketIntroSequence()
        {
            ...
            SetDialogue("Some little words cannot be sounded out. They are just… themselves! Pop them in your pocket.");
            ...
            if (activityData != null && activityData.sightWords != null)
            {
                for (int i = 0; i < activityData.sightWords.Length; i++)
                {
                    ...
                    string display = card.word == "the" ? "This one says 'the'. Not /t/-/h/-/e/ — just 'the'!" : $"'{card.word}' — into your pocket!";
                    SetDialogue(display);
        ...
        private IEnumerator CompleteStop3Sequence()
        {
            ...
            SetDialogue("Four whole sentences conquered! Get ready for Story Time!");
