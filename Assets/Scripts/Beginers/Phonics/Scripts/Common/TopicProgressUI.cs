...
public class TopicProgressUI : MonoBehaviour
{
    ...
    public static string FormatTopicName(string key)
    {
        ...
        switch (norm)
        {
            ...
            case "blenditagain": return "Blend It Again";
            case "wordbuilder": return "Word Builder";
            case "wordbuildervalley": return "Word Builder Valley";
            case "myfirstsentences": return "My First Sentences";
            case "sentencestreet": return "Sentence Street";
            case "storytime": return "Story Time";
            case "storytimevalley": return "Story Time Valley";
            default:
